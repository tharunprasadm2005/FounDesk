...
with app.app_context():
    ...
    # Delete old test raw_events with test source_ids
    conn.execute(db.text("DELETE FROM raw_events WHERE source_id LIKE 'test_%'"))
    conn.commit()

    # Delete any meeting notes that came from these test events
    ...
    test_records = [
        {
            "source": "google_meet",
            "source_id": "test_meet_001",
            "source_ref": "meet_ref_001",
            "event_type": "meeting",
        ...
        {
            "source": "calendly",
            "source_id": "test_calendly_001",
            "source_ref": "calendly_ref_001",
            "event_type": "event",
            ...
            "raw_payload": json.dumps({
                ...
                "actor": "thunprasadm2005@gmail.com"
            }),
            "is_mock": True
        },
        {
            "source": "notion",
            "source_id": "test_notion_001",
            "source_ref": "notion_ref_001",
            "event_type": "page",
        ...
        {
            "source": "slack",
            "source_id": "test_slack_001",
            "source_ref": "slack_ref_001",
            "event_type": "message",
    ...
    if all_events:
        ...
        if not notes:
            print("  No meeting notes created. Checking raw_events content...")
            for ev in all_events:
                ...
                if isinstance(p, dict):
                    ...
                    details = str(p.get('details', ''))[:100]
                    print(f"  RawEvent ID={ev.id} src={ev.source} title={title}")
                    print(f"    details[:100]={details}")
